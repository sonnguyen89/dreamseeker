	...
	<div class="ytc-row row">
		...
		<?php  if ($ytchag_link): ?>
			<div class="ytc-youtubelink <?php echo empty($ytchag_promotion) ? 'col-xs-12' : 'col-xs-7'; ?>">
                            <a style="color: #000000;" href="https://www.youtube.com/playlist?list=<?php echo $ytchag_playlist?>" class="ytcmore" <?php echo ($ytchag_link_window ? 'target="_blank"' : '')?>>
					<?php echo ($ytchag_link_tx ? $ytchag_link_tx : _e('READ ALL', 'youtube-channel-gallery'))?>
				</a>
			</div>
		<?php endif; ?> 
	</div>
