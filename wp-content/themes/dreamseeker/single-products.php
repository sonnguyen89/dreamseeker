...
// var_dump($video_poster_image);exit;
// $video_poster_image1 =  isset($video_poster_image['url']);
if ($product_video_empty != '' && $video_poster_image != '') {
    ?>
            ...
            <?php } ?>              
                                ...
                                <div id="collapse<?php echo $i; ?>" 
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $spec_it = $spec['specification_item'];
...
<!--            <div class="up_dealers_arrw"></div>-->
            <div class="all_cmpny_info">
            <?php
            $post_id = $post->ID;
            $query_ = array();
...
<!--            <div class="down_dealers_arrw"></div>-->
        </div>
        <script type="text/javascript">     
        ...
        <div class="col-sm-7 sing_map EqHeightDiv1">
            <div id="map" class="EqHeightDiv1" style="min-height:169px;width:100%;"></div>
        </div>
    </div> 
</div>
