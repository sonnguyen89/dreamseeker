            ...
            $args = array(
                ...
                foreach ($post_ids as $_post1) {
                  ...
                  <span class="sc_met">
                      ...
                      <p><b>Size:</b><?php if($sz_ft != '' || $sz_inch !='') { ?><?php echo $sz_ft; ?>'<?php echo $sz_inch; ?>"<?php } ?></p><?php // echo get_field('search_fileds', $_post1->ID); ?>
                      <p><b>Occupants: </b><?php echo get_field('price_thousands', $_post1->ID); ?></p>
                      <p><b>Tare: </b><?php echo get_field('tare', $_post1->ID); ?></p>
                      <p><b>Ball Weight: </b><?php echo get_field('ball_weight', $_post1->ID); ?></p>
                  </span>
                  </span></span>
                 </a>
                  </li>
